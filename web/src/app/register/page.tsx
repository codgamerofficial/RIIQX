...
export default function RegisterPage() {
    ...
    const passwordStrength = (password: string) => {
        if (password.length < 6) return { strength: "weak", color: "text-neon-red" };
        if (password.length < 10) return { strength: "medium", color: "text-bewakoof-yellow" };
        return { strength: "strong", color: "text-bewakoof-green" };
    };
            ...
            <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-muted-foreground">Join the RIIQX community</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <div>
                            ...
                            {formData.password && (
                                <p className={`text-xs mt-2 ${strength.color} font-bold uppercase`}>
                        ...
                        <label className="flex items-start gap-3 cursor-pointer">
                            <input
                                ...
                                className="mt-1 w-4 h-4 rounded border-white/20 bg-neutral-800 text-bewakoof-yellow focus:ring-bewakoof-yellow"
                            />
                            <span className="text-sm text-muted-foreground">
                                I agree to the{" "}
                                <Link href="/terms-of-service" className="text-bewakoof-yellow hover:underline">
                                    Terms of Service
                                </Link>{" "}
                                and{" "}
                                <Link href="/privacy-policy" className="text-bewakoof-yellow hover:underline">
                                    Privacy Policy
                                </Link>
                            </span>
                        </label>
                    ...
                    <p className="mt-8 text-center text-sm text-muted-foreground">
                        ...
                        <Link href="/login" className="text-bewakoof-yellow hover:underline font-bold">
                            Login
                        </Link>
                    </p>
                </motion.div>
