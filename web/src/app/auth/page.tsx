                    ...
                    {mode !== "reset" && (
                        <>
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full bg-[#24292e] text-white hover:bg-[#2f363d] border border-white/10 font-bold uppercase tracking-wider py-3.5 rounded-lg transition-all flex items-center justify-center gap-2 mt-3"
                            >
