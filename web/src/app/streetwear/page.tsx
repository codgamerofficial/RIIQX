                            ...
                            {products.length > 0 ? (
                                ...
                                <div className="space-y-12">
                                    <div className="text-center py-12 border border-dashed border-white/10 rounded-2xl">
                                        <p className="text-muted-foreground text-lg mb-2">No street ops found.</p>
                                        <a href="/streetwear" className="text-[#D9F99D] underline mt-2 inline-block mb-8">Clear all filters</a>
