...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#050505] flex">
            ...
            <div className="hidden lg:block w-1/2 relative bg-[#020202]">
                <AuthProductShowcase />
            </div>
                    ...
                    <AnimatePresence mode="wait">
                        {user ? (
                            ...
                            <motion.div
                                ...
                                initial="hidden"
                                animate="visible"
                                className="bg-[#0a0a0a]/80 backdrop-blur-md border border-white/10 p-8 md:p-10 clip-path-slant relative shadow-2xl"
                            >
                                {/* Header */}
                                <motion.div variants={itemVariants} className="text-center mb-10">
                                    <h1 className="text-5xl font-black text-white uppercase tracking-tighter font-display italic mb-2">
                                        Welcome <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50">Back</span>
                                    </h1>
                                ...
                                <form onSubmit={handleLogin} className="space-y-6">
                                    ...
                                    <motion.div variants={itemVariants} className="group">
                                        <label className="block text-[10px] font-bold text-white/40 uppercase tracking-widest mb-2 group-focus-within:text-accent transition-colors">
                                            Email Address
                                        </label>
                                    ...
                                    <motion.div variants={itemVariants} className="flex items-center justify-between pt-2">
                                        <label className="flex items-center gap-3 cursor-pointer group">
                                            ...
                                            <span className="text-[10px] uppercase font-bold text-white/40 group-hover:text-white transition-colors">Remember me</span>
                                        </label>
                                        <Link
                                            href="/forgot-password"
                                            className="text-[10px] uppercase font-bold text-accent hover:text-white transition-colors underline decoration-accent/30 underline-offset-4 hover:decoration-white"
                                        >
                                            Recover Access
                                        </Link>
                                    </motion.div>
                                ...
                                <motion.div variants={itemVariants} className="mt-8 text-center">
                                    <Link href="/register" className="text-white/40 hover:text-white text-[10px] font-mono uppercase tracking-widest transition-colors">
                                        New User? <span className="text-accent underline decoration-accent/30 underline-offset-4 hover:decoration-white font-bold ml-2">Initialize Account</span>
                                    </Link>
                                </motion.div>
                            </motion.div>
                        )}
